...
/**
 * Assignment #8. STL Vector vs. Linked List
 *
...
void quick_test()
{
    ...
    cout << "Constructor: " << Node::get_constructor_count() << endl;
    cout << "       Copy: " << Node::get_copy_count() << endl;
    cout << " Destructor: " << Node::get_destructor_count() << endl;
    cout << "SortedVector sv ..." << endl;
    SortedVector sv;
    cout << "Constructor: " << Node::get_constructor_count() << endl;
    cout << "       Copy: " << Node::get_copy_count() << endl;
    cout << " Destructor: " << Node::get_destructor_count() << endl;
    cout << "vector_prepends(sv, 8888) ..." << endl;
    sv.prepend(8888);
    cout << "Constructor: " << Node::get_constructor_count() << endl;
    cout << "       Copy: " << Node::get_copy_count() << endl;
    cout << " Destructor: " << Node::get_destructor_count() << endl;
